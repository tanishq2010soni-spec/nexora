...
class _$IntegrationImpl implements _Integration {
  const _$IntegrationImpl({
    ...
    final Map<String, String> config = const <String, String>{},
    this.connectedAt,
  ...
  @override
  String toString() {
    return 'Integration(id: $id, orgId: $orgId, name: $name, type: $type, description: $description, logoUrl: $logoUrl, status: $status, config: $config, connectedAt: $connectedAt, createdAt: $createdAt)';
  }
